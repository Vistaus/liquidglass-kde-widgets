...
// "Clocks" config page for City I / City II — an editable list of up to
// `maxClocks` cities. Each row picks an IANA timezone and an optional label.
// Stored in the `clocks` String kcfg as comma-joined "Zone|Label" items.
//
...
ColumnLayout {
    ...
    Kirigami.InlineMessage {
        ...
        text: i18n("Add up to %1 cities. Resize the widget wide for a row layout, or square for a grid.", page.maxClocks)
    }
